...
echo "<pre>";
echo $this->state->get('wave.id');
echo "<br>";
echo $this->state->get('wave.route');
echo "<br>";
echo $this->state->get('wave.type');
echo "<br>";
echo $this->doctorSay[0]->diagnosis;
echo "<br>";
echo 'hh'.$this->state->get('wave.diagnosis');
echo "</pre>";
...
?>
    ...
    <div class="box1" id="doctorsay" style="border: 1px solid #ccc; padding: 1px;"><?php echo "<h1>Doctor Say:</h1><br>".$this->doctorSay[0]->diagnosis;?></div>
